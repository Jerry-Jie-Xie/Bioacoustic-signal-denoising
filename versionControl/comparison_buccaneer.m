...
close all; clear; clc;
%======================%
noiseReductionMethods = {'Berouti', 'Boll', 'Towsey', 'MultiBandKamath', 'MMSESTSA', 'Wiener',...
    'Wavelet-Jie'};

% noiseReductionMethods = {'Towsey'};
%=========Whistle=============%
...
for iMethod = 1:nMethods
    ...
    % add factory1 noise
    wavin3 = load('.\noise\buccaneer1.mat'); % load babble noise
    wavin3 = wavin3.buccaneer1;
