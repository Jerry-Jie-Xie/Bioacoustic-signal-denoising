...
close all; clear; clc;
%======================%
% noiseReductionMethods = {'Berouti', 'Boll', 'Towsey', 'MultiBandKamath', 'MMSESTSA', 'Wiener', 'Wavelet-Jie'};
noiseReductionMethods = {'Berouti', 'Boll', 'Towsey', 'MultiBandKamath', 'MMSESTSA', 'Wiener', 'Wavelet-Jie'};
